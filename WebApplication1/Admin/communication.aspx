<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin.Master" AutoEventWireup="true" CodeBehind="communication.aspx.cs" Inherits="WebApplication1.Admin.communication" %>
        ...
        function send_message() {
            ...
            xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    ...
                    var t = document.createTextNode("Admin@gmail.com : " + document.getElementById("t1").value);
                    x.appendChild(t);
            ...
            xmlhttp.open("GET", "messages_send_from_admin.aspx?username=" + username + "&msg=" + document.getElementById("t1").value, true);
            xmlhttp.send();
