<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="sendmessage.aspx.cs" Inherits="WebApplication1.User.sendmessage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="c1" runat="server">
    ...
    <input type="text" id="username" value="<% Response.Write(Session["user"].ToString()); %>" style="display: none" />
    ...
    <script type="text/javascript">
        ...
        function send_message() {
            ...
            xmlhttp.open("GET", "messages_send_from_user.aspx?msg=" + document.getElementById("t1").value, true);
            xmlhttp.send();
